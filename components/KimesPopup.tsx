...
const TEXT: Record<string, { badge: string; title: string; date: string; place: string; desc: string; items: string[]; cta: string; today: string; close: string }> = {
  KR: {
    badge: '전시회 참가 안내',
    title: 'KIMES BUSAN 2026',
    date: '2026. 10. 22(목) ~ 10. 25(일)',
    place: 'BEXCO 부산',
    desc: '팔로우코리아가 부산 국제 의료기기·병원설비 전시회에 참가합니다.\n부스에 방문하시면 아래 내용을 직접 시연해 드립니다.',
    items: ['해외환자 유치 플랫폼 · 52개 제휴 병원', '병원 운영 SaaS 강남펄스 실화면 데모', '왕홍·KOL+KOC 중국 마케팅 · 중국 진출 상담'],
    cta: '카카오톡으로 미팅 예약',
    today: '오늘 하루 보지 않기',
    close: '닫기',
  },
  EN: {
    ...
    title: 'KIMES BUSAN 2026',
    date: 'Oct 22 (Thu) – 25 (Sun), 2026',
    place: 'BEXCO, Busan',
    desc: 'Follow Korea is exhibiting at KIMES Busan.\nVisit our booth for a live demo of:',
    items: ['International patient platform · 52 partner hospitals', 'Gangnam Pulse clinic SaaS live demo', 'China marketing (Wanghong · KOL+KOC) consulting'],
  ...
  CN: {
    badge: '展会参展通知',
    title: 'KIMES BUSAN 2026',
    date: '2026.10.22(周四) ~ 10.25(周日)',
    place: '釜山 BEXCO',
    desc: 'Follow Korea 将参加釜山国际医疗器械展。\n欢迎莅临展位，现场演示：',
    items: ['海外患者引流平台 · 52家合作医院', '医院运营SaaS 江南Pulse 实机演示', '网红·KOL+KOC 中国营销 · 中国市场进入咨询'],
    cta: '通过KakaoTalk预约洽谈',
    today: '今日不再显示',
    close: '关闭',
  },
