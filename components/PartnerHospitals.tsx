...
const CAT_KEYS = ['all', '성형외과', '피부', '줄기세포', '안과', '여성의학', '체형', '항노화', '한방', '치과', '검진', '신경과', '기타 서비스'] as const;
...
const I18N: Record<LanguageCode, Labels> = {
  KR: { eyebrow: 'Partner Hospitals', title: '강남 프리미엄 제휴 병원 네트워크', sub: '팔로우코리아가 직접 검증하고 계약한 병원들과 함께합니다. 전 병원 다국어 상담·사후관리 연동.',
    ...
    cats: { all: '전체', 성형외과: '성형외과', 피부: '피부', 줄기세포: '줄기세포', 안과: '안과', 여성의학: '여성의학', 체형: '체형', 항노화: '항노화', 한방: '한방', 치과: '치과', 검진: '건강검진', 신경과: '신경과', '기타 서비스': '헤어·뷰티·스튜디오' },
  ...
  EN: { eyebrow: 'Partner Hospitals', title: 'Premium Partner Hospital Network in Gangnam', sub: 'Hospitals directly verified and contracted by Follow Korea — multilingual consultation and aftercare across every partner.',
    ...
    cats: { all: 'All', 성형외과: 'Plastic Surgery', 피부: 'Skin', 줄기세포: 'Stem Cell', 안과: 'Eye', 여성의학: "Women's Health", 체형: 'Body', 항노화: 'Anti-aging', 한방: 'Korean Med', 치과: 'Dental', 검진: 'Health Checkup', 신경과: 'Neurology', '기타 서비스': 'Hair·Beauty·Studio' },
  ...
  CN: { eyebrow: 'Partner Hospitals', title: '江南高端合作医院网络', sub: 'Follow Korea 亲自考察并签约的合作医院 — 全部医院支持多语言咨询与术后管理。',
    ...
    cats: { all: '全部', 성형외과: '整形外科', 피부: '皮肤', 줄기세포: '干细胞', 안과: '眼科', 여성의학: '女性医学', 체형: '体型', 항노화: '抗衰老', 한방: '韩方', 치과: '牙科', 검진: '健康体检', 신경과: '神经内科', '기타 서비스': '美发·美容·摄影' },
  ...
  JP: { eyebrow: 'Partner Hospitals', title: '江南プレミアム提携病院ネットワーク', sub: 'Follow Koreaが直接検証・契約した病院と提携。全病院で多言語相談・アフターケアに対応。',
    ...
    cats: { all: 'すべて', 성형외과: '美容外科', 피부: '皮膚', 줄기세포: '幹細胞', 안과: '眼科', 여성의학: '婦人科', 체형: 'ボディ', 항노화: 'アンチエイジング', 한방: '韓方', 치과: '歯科', 검진: '健康診断', 신경과: '神経内科', '기타 서비스': 'ヘア・ビューティー・スタジオ' },
  ...
  ID: { eyebrow: 'Partner Hospitals', title: 'Jaringan Rumah Sakit Mitra Premium di Gangnam', sub: 'Rumah sakit yang diverifikasi dan dikontrak langsung oleh Follow Korea — konsultasi multibahasa dan perawatan lanjutan.',
    ...
    cats: { all: 'Semua', 성형외과: 'Bedah Plastik', 피부: 'Kulit', 줄기세포: 'Sel Punca', 안과: 'Mata', 여성의학: 'Kesehatan Wanita', 체형: 'Tubuh', 항노화: 'Anti-aging', 한방: 'Pengobatan Korea', 치과: 'Gigi', 검진: 'Medical Check Up', 신경과: 'Neurologi', '기타 서비스': 'Salon·Kecantikan·Studio' },
  ...
  AR: { eyebrow: 'Partner Hospitals', title: 'شبكة المستشفيات الشريكة المتميزة في جانجنام', sub: 'مستشفيات تحققت منها Follow Korea وتعاقدت معها مباشرة — استشارات متعددة اللغات ورعاية لاحقة.',
    ...
    cats: { all: 'الكل', 성형외과: 'جراحة التجميل', 피부: 'الجلدية', 줄기세포: 'الخلايا الجذعية', 안과: 'العيون', 여성의학: 'صحة المرأة', 체형: 'نحت الجسم', 항노화: 'مكافحة الشيخوخة', 한방: 'الطب الكوري', 치과: 'الأسنان', 검진: 'الفحص الطبي', 신경과: 'الأعصاب', '기타 서비스': 'صالونات وتصوير' },
  ...
  KH: { eyebrow: 'Partner Hospitals', title: 'បណ្ដាញមន្ទីរពេទ្យដៃគូលំដាប់ខ្ពស់នៅ Gangnam', sub: 'មន្ទីរពេទ្យដែល Follow Korea បានផ្ទៀងផ្ទាត់ និងចុះកិច្ចសន្យាដោយផ្ទាល់ — ការប្រឹក្សាច្រើនភាសា និងការថែទាំក្រោយព្យាបាល។',
    ...
    cats: { all: 'ទាំងអស់', 성형외과: 'វះកាត់កែសម្ផស្ស', 피부: 'សើស្បែក', 줄기세포: 'កោសិកាដើម', 안과: 'ភ្នែក', 여성의학: 'សុខភាពស្ត្រី', 체형: 'រាងកាយ', 항노화: 'ប្រឆាំងភាពចាស់', 한방: 'ឱសថកូរ៉េ', 치과: 'ធ្មេញ', 검진: 'ពិនិត្យសុខភាព', 신경과: 'ប្រព័ន្ធសរសៃប្រសាទ', '기타 서비스': 'សាឡន·ស្ទូឌីយោ' },
  ...
  VI: { eyebrow: 'Partner Hospitals', title: 'Mạng lưới bệnh viện đối tác cao cấp tại Gangnam', sub: 'Các bệnh viện được Follow Korea trực tiếp thẩm định và ký hợp đồng — tư vấn đa ngôn ngữ và chăm sóc hậu phẫu.',
    ...
    cats: { all: 'Tất cả', 성형외과: 'PT thẩm mỹ', 피부: 'Da liễu', 줄기세포: 'Tế bào gốc', 안과: 'Mắt', 여성의학: 'Sức khỏe phụ nữ', 체형: 'Vóc dáng', 항노화: 'Chống lão hóa', 한방: 'Y học Hàn Quốc', 치과: 'Nha khoa', 검진: 'Khám sức khỏe', 신경과: 'Thần kinh', '기타 서비스': 'Salon·Làm đẹp·Studio' },
  ...
  RU: { eyebrow: 'Partner Hospitals', title: 'Сеть премиальных клиник-партнёров в Каннаме', sub: 'Клиники, лично проверенные и законтрактованные Follow Korea — многоязычные консультации и постпроцедурный уход.',
    ...
    cats: { all: 'Все', 성형외과: 'Пластика', 피부: 'Кожа', 줄기세포: 'Стволовые клетки', 안과: 'Офтальмология', 여성의학: 'Женское здоровье', 체형: 'Тело', 항노화: 'Anti-age', 한방: 'Корейская медицина', 치과: 'Стоматология', 검진: 'Чекап', 신경과: 'Неврология', '기타 서비스': 'Салоны·Студии' },
...
const PartnerHospitals: React.FC<{ lang: LanguageCode }> = ({ lang }) => {
  ...
  const isLife = (h: HospDetail) => h.cat.includes('기타 서비스');
  // 전체 보기: 병원 먼저, 라이프스타일(기타 서비스)은 맨 뒤 그룹으로
  const filtered = cat === 'all' ? [...HOSPITAL_DATA.filter(h => !isLife(h)), ...HOSPITAL_DATA.filter(isLife)] : HOSPITAL_DATA.filter(h => h.cat.includes(cat));
