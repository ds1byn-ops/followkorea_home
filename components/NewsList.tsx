...
const NewsList: React.FC<NewsListProps> = ({ onClose, lang }) => {
  const t = {
    KR: { 
      ...
      back: '메인 페이지로 돌아가기',
      items: [
        { category: '보도자료', title: '팔로우코리아, 신우성 공동대표 영입…글로벌 의료관광 사업 강화', date: '2026.07.24', img: 'https://img.etnews.com/news/article/2026/07/24/news-p.v1.20260724.af2bf30ec78048b08569a817af200cb0_P1.png', url: 'https://www.etnews.com/20260724000213' },
    ...
    EN: { 
      ...
      items: [
        { category: 'Press', title: 'Follow Korea Appoints Shin Woo-sung as Co-CEO to Strengthen Global Medical Tourism', date: '2026.07.24', img: 'https://img.etnews.com/news/article/2026/07/24/news-p.v1.20260724.af2bf30ec78048b08569a817af200cb0_P1.png', url: 'https://www.etnews.com/20260724000213' },
    ...
    CN: { 
      ...
      back: '返回首页',
      items: [
        { category: '新闻', title: 'Follow Korea 引入申宇成为共同代表，强化全球医疗旅游业务', date: '2026.07.24', img: 'https://img.etnews.com/news/article/2026/07/24/news-p.v1.20260724.af2bf30ec78048b08569a817af200cb0_P1.png', url: 'https://www.etnews.com/20260724000213' },
    ...
    JP: {
      ...
      back: 'メインページに戻る',
      items: [
        { category: 'プレスリリース', title: 'Follow Korea、シン・ウソン共同代表を迎え…グローバル医療ツーリズム事業を強化', date: '2026.07.24', img: 'https://img.etnews.com/news/article/2026/07/24/news-p.v1.20260724.af2bf30ec78048b08569a817af200cb0_P1.png', url: 'https://www.etnews.com/20260724000213' },
    ...
    ID: {
      ...
      items: [
        { category: 'Siaran Pers', title: 'Follow Korea Angkat Shin Woo-sung sebagai Co-CEO untuk Perkuat Wisata Medis Global', date: '2026.07.24', img: 'https://img.etnews.com/news/article/2026/07/24/news-p.v1.20260724.af2bf30ec78048b08569a817af200cb0_P1.png', url: 'https://www.etnews.com/20260724000213' },
    ...
    AR: {
      ...
      items: [
        { category: 'بيان صحفي', title: 'Follow Korea تعيّن شين وو-سونغ رئيساً تنفيذياً مشاركاً لتعزيز السياحة العلاجية العالمية', date: '2026.07.24', img: 'https://img.etnews.com/news/article/2026/07/24/news-p.v1.20260724.af2bf30ec78048b08569a817af200cb0_P1.png', url: 'https://www.etnews.com/20260724000213' },
    ...
    KH: {
      ...
      items: [
        { category: 'សេចក្តីប្រកាសព័ត៌មាន', title: 'Follow Korea តែងតាំង Shin Woo-sung ជាសហនាយក ដើម្បីពង្រឹងទេសចរណ៍វេជ្ជសាស្ត្រសកល', date: '2026.07.24', img: 'https://img.etnews.com/news/article/2026/07/24/news-p.v1.20260724.af2bf30ec78048b08569a817af200cb0_P1.png', url: 'https://www.etnews.com/20260724000213' },
    ...
    VI: {
      ...
      back: 'Về trang chính',
      items: [
        { category: 'Thông cáo báo chí', title: 'Follow Korea bổ nhiệm Shin Woo-sung làm đồng Tổng Giám đốc, tăng cường du lịch y tế toàn cầu', date: '2026.07.24', img: 'https://img.etnews.com/news/article/2026/07/24/news-p.v1.20260724.af2bf30ec78048b08569a817af200cb0_P1.png', url: 'https://www.etnews.com/20260724000213' },
    ...
    RU: {
      ...
      items: [
        { category: 'Пресс-релиз', title: 'Follow Korea назначает Шин У Сона со-гендиректором для усиления медицинского туризма', date: '2026.07.24', img: 'https://img.etnews.com/news/article/2026/07/24/news-p.v1.20260724.af2bf30ec78048b08569a817af200cb0_P1.png', url: 'https://www.etnews.com/20260724000213' },
