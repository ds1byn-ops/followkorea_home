...
const NewsList: React.FC<NewsListProps> = ({ onClose, lang }) => {
  const t = {
    KR: { 
      ...
      back: '메인 페이지로 돌아가기',
      items: [
        { category: '보도자료', title: '팔로우코리아, ‘강남펄스’로 외국인환자 유입부터 소개자 정산까지 통합 관리 (KIMES BUSAN 참가업체 뉴스)', date: '2026.09.18', img: '/fk-news-kimes.jpg', url: 'https://kimesbusan.com/ko/media/exhibitor-news/detail/76' },
    ...
    EN: { 
      ...
      items: [
        { category: 'Press', title: 'Follow Korea Manages Patient Inflow to Referrer Settlement in One System with ‘Gangnam Pulse’ (KIMES BUSAN Exhibitor News)', date: '2026.09.18', img: '/fk-news-kimes.jpg', url: 'https://kimesbusan.com/ko/media/exhibitor-news/detail/76' },
        ...
        { category: 'Press', title: 'Follow Korea-GCNC Sign Strategic Business Agreement to Support Global Expansion', date: '2025.11.19', img: '/gcnc-news.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    },
    CN: { 
      badge: 'Media Center', 
      ...
      back: '返回首页',
      items: [
        { category: '新闻', title: 'Follow Korea 以「江南脉动」一站式管理海外患者引流与介绍人结算（KIMES BUSAN 参展商新闻）', date: '2026.09.18', img: '/fk-news-kimes.jpg', url: 'https://kimesbusan.com/ko/media/exhibitor-news/detail/76' },
        ...
        { category: '新闻', title: 'Follow Korea 与 GCNC 签署战略合作协议，助力国内企业出海', date: '2025.11.19', img: '/gcnc-news.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    },
    JP: {
      badge: 'Media Center',
      ...
      back: 'メインページに戻る',
      items: [
        { category: 'プレスリリース', title: 'Follow Korea、中国・上海法人の設立完了…中国人患者誘致を本格化', date: '2026.09.16', img: '/fk-news-cn.png', url: 'https://www.etnews.com/20260916000307' },
        ...
        { category: 'プレスリリース', title: 'Follow Korea・GCNC、国内企業の海外進出支援強化のため戦略的業務協約を締結', date: '2025.11.19', img: '/gcnc-news.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    },
    ID: {
      badge: 'Media Center',
      ...
      items: [
        { category: 'Siaran Pers', title: 'Follow Korea Rampungkan Pendirian Badan Hukum Shanghai, Percepat Penarikan Pasien Tiongkok', date: '2026.09.16', img: '/fk-news-cn.png', url: 'https://www.etnews.com/20260916000307' },
        ...
        { category: 'Siaran Pers', title: 'Follow Korea-GCNC Tandatangani Perjanjian Strategis untuk Dukung Ekspansi Global', date: '2025.11.19', img: '/gcnc-news.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    },
    AR: {
      badge: 'Media Center',
      ...
      items: [
        { category: 'بيان صحفي', title: 'Follow Korea تُكمل تأسيس شركتها في شنغهاي… انطلاقة جذب المرضى الصينيين', date: '2026.09.16', img: '/fk-news-cn.png', url: 'https://www.etnews.com/20260916000307' },
        ...
        { category: 'بيان صحفي', title: 'Follow Korea و GCNC توقعان اتفاقية استراتيجية لدعم التوسع العالمي للشركات المحلية', date: '2025.11.19', img: '/gcnc-news.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    },
    KH: {
      badge: 'Media Center',
      ...
      items: [
        { category: 'សេចក្តីប្រកាសព័ត៌មាន', title: 'Follow Korea បញ្ចប់ការបង្កើតក្រុមហ៊ុននៅសៀងហៃ ចាប់ផ្តើមទាក់ទាញអ្នកជំងឺចិន', date: '2026.09.16', img: '/fk-news-cn.png', url: 'https://www.etnews.com/20260916000307' },
        ...
        { category: 'សេចក្តីប្រកាសព័ត៌មាន', title: 'Follow Korea និង GCNC ចុះហត្ថលេខាលើកិច្ចព្រមព្រៀងយុទ្ធសាស្ត្រ ដើម្បីគាំទ្រការពង្រីកសកល', date: '2025.11.19', img: '/gcnc-news.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    },
    VI: {
      badge: 'Media Center',
      ...
      back: 'Về trang chính',
      items: [
        { category: 'Thông cáo báo chí', title: 'Follow Korea hoàn tất thành lập pháp nhân Thượng Hải, đẩy mạnh thu hút bệnh nhân Trung Quốc', date: '2026.09.16', img: '/fk-news-cn.png', url: 'https://www.etnews.com/20260916000307' },
        ...
        { category: 'Thông cáo báo chí', title: 'Follow Korea-GCNC ký kết thỏa thuận chiến lược hỗ trợ mở rộng ra toàn cầu', date: '2025.11.19', img: '/gcnc-news.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    },
    RU: {
      badge: 'Media Center',
      ...
      items: [
        { category: 'Пресс-релиз', title: 'Follow Korea завершила регистрацию компании в Шанхае — старт привлечения китайских пациентов', date: '2026.09.16', img: '/fk-news-cn.png', url: 'https://www.etnews.com/20260916000307' },
        ...
        { category: 'Пресс-релиз', title: 'Follow Korea и GCNC подписали стратегическое соглашение для поддержки глобальной экспансии', date: '2025.11.19', img: '/gcnc-news.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    }
  }[lang];
