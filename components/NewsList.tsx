  ...
  const t = {
    KR: { 
      ...
      items: [
        ...
        { category: '보도자료', title: '에스에이컴퍼니, ‘팔로우 코리아’ 시즌2 K-뷰티 의료관광 글로벌 프로젝트 개최', date: '2025.11.13', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/6bfafba46f880.jpg', url: 'https://star.mbn.co.kr/entertain/11467451?refer=portal' },
    ...
    EN: { 
      ...
      items: [
        ...
        { category: 'Press', title: 'SA Company-GCNC Sign Strategic Business Agreement to Support Global Expansion', date: '2025.11.19', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/ff65c4d98d8d0.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    },
    CN: { 
      badge: 'Media Center', 
      ...
      items: [
        ...
        { category: '新闻', title: 'SA Company 与 GCNC 签署战略合作协议，助力国内企业出海', date: '2025.11.19', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/ff65c4d98d8d0.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    },
    JP: {
      badge: 'Media Center',
      ...
      items: [
        ...
        { category: 'プレスリリース', title: "SAカンパニー、『Follow Korea』シーズン2 K-ビューティー医療ツーリズムグローバルプロジェクト開催", date: '2025.11.13', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/6bfafba46f880.jpg', url: 'https://star.mbn.co.kr/entertain/11467451?refer=portal' },
        ...
        { category: 'プレスリリース', title: 'SAカンパニー・GCNC、国内企業の海外進出支援強化のため戦略的業務協約を締結', date: '2025.11.19', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/ff65c4d98d8d0.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    },
    ID: {
      badge: 'Media Center',
      ...
      items: [
        ...
        { category: 'Siaran Pers', title: "SA Company Gelar Proyek Global Wisata Medis K-Beauty 'Follow Korea' Musim 2", date: '2025.11.13', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/6bfafba46f880.jpg', url: 'https://star.mbn.co.kr/entertain/11467451?refer=portal' },
        ...
        { category: 'Siaran Pers', title: 'SA Company-GCNC Tandatangani Perjanjian Strategis untuk Dukung Ekspansi Global', date: '2025.11.19', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/ff65c4d98d8d0.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    },
    AR: {
      badge: 'Media Center',
      ...
      items: [
        ...
        { category: 'بيان صحفي', title: "شركة SA تطلق المشروع العالمي للسياحة العلاجية للجمال الكوري 'Follow Korea' الموسم الثاني", date: '2025.11.13', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/6bfafba46f880.jpg', url: 'https://star.mbn.co.kr/entertain/11467451?refer=portal' },
        ...
        { category: 'بيان صحفي', title: 'شركة SA و GCNC توقعان اتفاقية استراتيجية لدعم التوسع العالمي للشركات المحلية', date: '2025.11.19', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/ff65c4d98d8d0.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    },
    KH: {
      badge: 'Media Center',
      ...
      items: [
        ...
        { category: 'សេចក្តីប្រកាសព័ត៌មាន', title: "ក្រុមហ៊ុន SA រៀបចំគម្រោងសកល 'Follow Korea' រដូវកាលទី2 ទេសចរណ៍វេជ្ជសាស្ត្រ K-Beauty", date: '2025.11.13', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/6bfafba46f880.jpg', url: 'https://star.mbn.co.kr/entertain/11467451?refer=portal' },
        ...
        { category: 'សេចក្តីប្រកាសព័ត៌មាន', title: 'ក្រុមហ៊ុន SA និង GCNC ចុះហត្ថលេខាលើកិច្ចព្រមព្រៀងយុទ្ធសាស្ត្រ ដើម្បីគាំទ្រការពង្រីកសកល', date: '2025.11.19', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/ff65c4d98d8d0.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    },
    VI: {
      badge: 'Media Center',
      ...
      items: [
        ...
        { category: 'Thông cáo báo chí', title: "SA Company tổ chức dự án toàn cầu Du lịch Y tế K-Beauty 'Follow Korea' mùa 2", date: '2025.11.13', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/6bfafba46f880.jpg', url: 'https://star.mbn.co.kr/entertain/11467451?refer=portal' },
        ...
        { category: 'Thông cáo báo chí', title: 'SA Company-GCNC ký kết thỏa thuận chiến lược hỗ trợ mở rộng ra toàn cầu', date: '2025.11.19', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/ff65c4d98d8d0.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    },
    RU: {
      badge: 'Media Center',
      ...
      items: [
        ...
        { category: 'Пресс-релиз', title: "Компания SA проводит глобальный проект медицинского туризма K-Beauty 'Follow Korea' Сезон 2", date: '2025.11.13', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/6bfafba46f880.jpg', url: 'https://star.mbn.co.kr/entertain/11467451?refer=portal' },
        ...
        { category: 'Пресс-релиз', title: 'Компании SA и GCNC подписали стратегическое соглашение для поддержки глобальной экспансии', date: '2025.11.19', img: 'https://cdn.imweb.me/upload/S20260120a0cc4980014ac/ff65c4d98d8d0.png', url: 'https://www.enetnews.co.kr/news/articleView.html?idxno=44232' }
      ]
    }
  }[lang];
