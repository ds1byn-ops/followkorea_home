...
const NewsList: React.FC<NewsListProps> = ({ onClose, lang }) => {
  const t = {
    KR: { 
      ...
      back: '메인 페이지로 돌아가기',
      items: [
        { category: '보도자료', title: '팔로우코리아, 중국 상해 법인 설립 완료…중국인 환자유치 본격화', date: '2026.09.16', img: '/fk-news-logo.png', url: 'https://www.etnews.com/20260916000307' },
    ...
    EN: { 
      ...
      items: [
        { category: 'Press', title: 'Follow Korea Completes Shanghai Subsidiary, Accelerating Chinese Patient Attraction', date: '2026.09.16', img: '/fk-news-logo.png', url: 'https://www.etnews.com/20260916000307' },
    ...
    CN: { 
      ...
      back: '返回首页',
      items: [
        { category: '新闻', title: 'Follow Korea 完成上海法人设立，全面启动中国患者引流业务', date: '2026.09.16', img: '/fk-news-logo.png', url: 'https://www.etnews.com/20260916000307' },
    ...
    JP: {
      ...
      back: 'メインページに戻る',
      items: [
        { category: 'プレスリリース', title: 'Follow Korea、中国・上海法人の設立完了…中国人患者誘致を本格化', date: '2026.09.16', img: '/fk-news-logo.png', url: 'https://www.etnews.com/20260916000307' },
    ...
    ID: {
      ...
      items: [
        { category: 'Siaran Pers', title: 'Follow Korea Rampungkan Pendirian Badan Hukum Shanghai, Percepat Penarikan Pasien Tiongkok', date: '2026.09.16', img: '/fk-news-logo.png', url: 'https://www.etnews.com/20260916000307' },
    ...
    AR: {
      ...
      items: [
        { category: 'بيان صحفي', title: 'Follow Korea تُكمل تأسيس شركتها في شنغهاي… انطلاقة جذب المرضى الصينيين', date: '2026.09.16', img: '/fk-news-logo.png', url: 'https://www.etnews.com/20260916000307' },
    ...
    KH: {
      ...
      items: [
        { category: 'សេចក្តីប្រកាសព័ត៌មាន', title: 'Follow Korea បញ្ចប់ការបង្កើតក្រុមហ៊ុននៅសៀងហៃ ចាប់ផ្តើមទាក់ទាញអ្នកជំងឺចិន', date: '2026.09.16', img: '/fk-news-logo.png', url: 'https://www.etnews.com/20260916000307' },
    ...
    VI: {
      ...
      back: 'Về trang chính',
      items: [
        { category: 'Thông cáo báo chí', title: 'Follow Korea hoàn tất thành lập pháp nhân Thượng Hải, đẩy mạnh thu hút bệnh nhân Trung Quốc', date: '2026.09.16', img: '/fk-news-logo.png', url: 'https://www.etnews.com/20260916000307' },
    ...
    RU: {
      ...
      items: [
        { category: 'Пресс-релиз', title: 'Follow Korea завершила регистрацию компании в Шанхае — старт привлечения китайских пациентов', date: '2026.09.16', img: '/fk-news-logo.png', url: 'https://www.etnews.com/20260916000307' },
